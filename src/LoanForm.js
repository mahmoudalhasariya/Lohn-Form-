...
//         <input value={loanInput.phoneNumber} onChange={(e)=>{
...
//         <input type="checkbox" checked={loanInput.isEmployee} onChange={(e)=>{
//             setLoanInput({...loanInput,isEmployee:e.target.checked})
//         }}/>

//         <label>Salary</label>
//         <select value={loanInput.salary} onChange={(e)=>{
...
//         <button id="sub-loan" disabled={loanInput.name==='' || loanInput.phoneNumber==='' || loanInput.age===''}>Submit</button>
//         </form>
//        {/* <Modal/> */}
//     </div>
//     );
